...
export const WHEEL_ZOOM_IDLE_DELAY_MS = 180;
export const CLICK_DRAG_TOLERANCE_PX = 5;
export const BLOCK_GRID_MIN_PIXEL_SIZE = 7;
export const ICON_MIN_MAP_CELL_PIXEL_SIZE = 7;
export const ICON_MAX_MAP_CELL_PIXEL_SIZE = 128;
export const MAP_ICON_MIN_SCALE = 1;
export const MAP_ICON_MAX_SCALE = 2.25;
export const MAP_ICON_BASE_SIZE_PX = 2.33 * 16;
export const MAP_ICON_HITBOX_BASE_SIZE_PX = 2.67 * 16;
export const POINT_TOOLTIP_OFFSET = 8;
export const ICON_TOOLTIP_OFFSET = 38;
export const ROUTE_PLAYER_MARKER_SIZE_PX = 35;
export const CONTENT_PREVIEW_DELAY_MS = 800;
export const CONTENT_PREVIEW_ANIMATION_DURATION_MS = 240;
export const FOCUS_MAP_CELL_PIXEL_SIZE = 11;
export const ROUTE_FOCUS_MAX_ZOOM_FACTOR = 2;
...
export const MAP_TOOLTIP_LABEL_Z_INDEX = 2000;
export const MAP_STATUS_BUBBLE_Z_INDEX = 2020;
export const MAP_CONTENT_CREATION_Z_INDEX = 2030;
...
export const getScaledMapIconSizePx = (baseSizePx: number, iconScale: number) => (
  Math.round(baseSizePx * iconScale)
);
