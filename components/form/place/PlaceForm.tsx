    ...
    <form className="space-y-5" onSubmit={handlePlaceSubmit}>
      <FormSection title="Informations générales">
        <CommonFields
          ...
          descriptionPlaceholder="Présentez le lieu, ses services et comment y accéder. Évitez de répéter les coordonnées ou adresses Nether déjà indiquées sur la fiche et les portails proches."
          disabled={submission.isSubmitting}
          form={fields}
