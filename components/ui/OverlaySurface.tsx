  ...
  function OverlaySurface({
    ...
    return (
      <section
        ...
        role="dialog"
        tabIndex={-1}
        className={`pointer-events-auto relative flex w-full min-w-0 flex-col overflow-hidden border outline-none ${sizeClasses[size]} ${heightClasses[resolvedHeight]} ${themeColors.border.primary} ${themeColors.panel.primary} ${themeColors.util.roundedXl} [box-shadow:0_0_25px_0_var(--tw-shadow-color)] ${shadowClass} ${className}`}
        style={style}
      >
        {children}
      </section>
